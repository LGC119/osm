...
class SaeTOAuthV2 {
    ...
    function authorizeURLopen()    { return 'https://open.weibo.cn/oauth2/authorize'; }
     ...
     * @return array
     */
    function getAuthorizeURL( $url, $response_type = 'code', $state = NULL, $display = NULL , $forcelogin = NULL) {
        $params = array();
        ...
        $url = (!empty($display) && $display='mobile' ) ? $this->authorizeURLopen() : $this->authorizeURL() ;
...
//=====自定义的方法  ren_kai@live.com ========================================== 

    /**
     * 退出登录 { @link http://open.weibo.com/wiki/2/account/end_session}
     */
