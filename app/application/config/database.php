...
$db['default_master']['password'] = 'mas123';
$db['default_master']['database'] = 'osm';
$db['default_master']['dbdriver'] = 'mysqli';
$db['default_master']['dbprefix'] = 'me_';
...
$db['default_slave']['hostname'] = 'localhost';
$db['default_slave']['username'] = 'root';
$db['default_slave']['password'] = 'mas123';
$db['default_slave']['database'] = 'osm';
$db['default_slave']['dbdriver'] = 'mysqli';
$db['default_slave']['dbprefix'] = 'me_';
